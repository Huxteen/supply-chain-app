...
class ModelTests(TestCase):
    ...
    def test_new_user_email_normalized(self):
        ...
        email = "test@husteen.COM"
        user = get_user_model().objects.create_user(email, 'test125')
    ...
    def test_new_user_invalid_email(self):
        ...
        with self.assertRaises(ValueError):
            get_user_model().objects.create_user(None, 'test147')
...
class publicUserApiTest(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@husteen.com','password': 'testtest'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        payload = {'email': 'test@husteen.com', 'password':'wrongpass'}
