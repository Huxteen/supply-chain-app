...
class privateProductApiTest(TestCase):
    ...
    def test_retrieve_product(self):
        ...
        Product.objects.create(name='MacBook M1', user_id=self.user, price=99.99, quantity_in_stock=200)
        Product.objects.create(name='LogiTech Mouse',user_id=self.user, price=299, quantity_in_stock=150)
    ...
    def test_create_product_successful(self):
        ...
        payload = {'name':'MacBook M1', 'user_id':admin_user, 'price':99.99, 'quantity_in_stock':200}
